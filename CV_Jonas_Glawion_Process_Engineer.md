...
Results-driven **Process Engineer** with over **8 years of experience** in plastics processing, specializing in **extrusion, compounding, and polyurethane (PUR) systems**. Proven track record in optimizing production lines, commissioning international projects, and implementing **Lean Six Sigma** methodologies. Strong technical background in **PLC automation** and **Industry 4.0** digital tools (Python, AI/ML). Seeking a challenging role in the plastics industry to leverage expertise in process design, troubleshooting, and continuous improvement.

---

## Core Competencies

*   **Process Engineering:** Extrusion (Twin/Single Screw), Compounding, Pelletizing (Strand/Underwater), PUR Foaming, Reaction Injection Molding.
*   **Optimization & Quality:** Lean Six Sigma, 5S, Root Cause Analysis (8D, Ishikawa), SPC, DOE, FMEA, PPAP.
*   **Automation & Digital:** PLC (Siemens S7, Schneider), SCADA, Python (Data Analysis), AI/ML for Quality Prediction.
*   **Materials:** Polypropylene (PP), Polyethylene (PE), Polyurethane (PUR), PET, Recycled Polymers, Bioplastics.

---

## Professional Experience

### **Autoneum** | Roßdorf, Germany
**Process Engineer - Automotive Plastics & PUR Foam Systems** | *Oct 2023 – Present*
...
**Bachelor of Engineering (B.Eng.) - Plastics Technology** | *2013 – 2017*
*   **Grade:** 2.8
*   **Thesis:** Process optimization in extrusion and compounding.
*   **Key Modules:** Polymer Chemistry, Extrusion Technology, Injection Molding, Automation.

---

## Early Career & Trade Skills

*   **Rest Bedachungen GmbH:** Roofer (Part-Time) | *2015 – 2017*
*   **Zahn Manfred Natursteine GmbH:** Apprentice Stonemason | *2007 – 2010*
    *   *Developed strong craftsmanship, precision, and a hands-on work ethic.*
...
*   **Spanish:** Basic (A2) - *Actively learning*

**Software:**
*   MS Office (Excel VBA), SAP, Siemens TIA Portal, Python (Pandas, Scikit-learn), CAD (Basic).

**Certifications:**
*   Lean Manufacturing & Six Sigma (Internal)
